...
urlpatterns = [    
    path('', v_view.IndexView.as_view(), name='index'),
...
urlpatterns += [
    ...
    # Optional UI:
    path('api/schema/swagger-ui/', login_required(SpectacularSwaggerView.as_view(url_name='schema')), name='swagger-ui'),
